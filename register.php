...
<?php include_once '_inc/header_1.php'; ?>
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post" action="register.php">
					...
					<div class="container-login100-form-btn">
						<button type="submit" class="login100-form-btn_2" name="reg_user">
							Sign up!
						</button>
					</div>
...
<?php include_once '_inc/footer_1.php'; ?>
</body>
</html>